...
void SMwriter_smc_old::add_comment(const char* comment)
{
  fprintf(stderr,"ERROR: add_comment not implemented\n");
}

void SMwriter_smc_old::set_nverts(int nverts)
{
  this->nverts = nverts;
}

void SMwriter_smc_old::set_nfaces(int nfaces)
{
  this->nfaces = nfaces;
}
