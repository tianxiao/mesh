...
static int gettime_sec;
static int gettime_msec;
...
int gettime_in_msec()
{
  ...
  sec = timebuffer.time - gettime_sec; 
  msec = timebuffer.millitm - gettime_msec; 

  gettime_sec = timebuffer.time;
  gettime_msec = timebuffer.millitm;
