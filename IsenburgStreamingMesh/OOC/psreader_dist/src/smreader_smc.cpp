...
bool SMreader_smc::open(FILE* file)
{
  ...
  {
    fprintf(stderr,"ERROR: this is SMreader_smc (%d or %d) but data requires SMreader (%d)\n",SM_VERSION_SME,SM_VERSION_SME_NON_FINALIZED_EOF,version);
    exit(0);
  }
