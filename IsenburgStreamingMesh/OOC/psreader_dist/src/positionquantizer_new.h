...
// EnQuantize:
//-----------------------------------------------------------------------------
inline void PositionQuantizerNew::EnQuantize(F32* pPosition, I32* pQuantPosition)
{
...
// DeQuantize:
//-----------------------------------------------------------------------------
inline void PositionQuantizerNew::DeQuantize(I32* pQuantPosition, F32* pPosition)
{
